...
public class VanillaTabLayout extends SlidingTabLayout {
	...
	public VanillaTabLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		setSelectedIndicatorColors(context.getResources().getColor(ch.blinkenlights.android.chocolate.R.color.tabs_active_indicator));
	...
	protected TextView createDefaultTabView(Context context) {
		...
		view.setTextColor(getResources().getColorStateList(ch.blinkenlights.android.chocolate.R.color.tab_text_selector));
		view.setBackgroundResource(ch.blinkenlights.android.chocolate.R.drawable.unbound_ripple_light);
		view.setMaxLines(1);
